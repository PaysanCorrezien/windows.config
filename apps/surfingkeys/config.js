...
:root {
    --theme-ace-bg: #191724;
    --theme-ace-bg-accent: #1f1d2e;
    --theme-ace-fg: #e0def4;
    --theme-ace-fg-accent: #524f67;
    --theme-ace-cursor: #524f67;
    --theme-ace-select: #26233a;
}

#sk_editor {
    background: var(--theme-ace-bg) !important;
    border: 1px solid var(--theme-ace-fg-accent) !important;
    box-shadow: 0px 2px 10px #21202e !important;
}

.ace_dialog-bottom {
    border-top: 1px solid var(--theme-ace-fg-accent) !important;
}
...
settings.focusOnSaved = false; // Don't focus text input after quitting vim editor

// Tridactyl-like navigation bindings
// Remove existing bindings first

// Set new bindings
api.map("H", "S"); // Previous page in history
api.map("L", "D"); // Next page in history
api.map("J", "E"); // Go one tab left
api.map("K", "R"); // Go one tab right

api.map("P", "cc"); // Open Clipboard URL in new tab
